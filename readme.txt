...
The system provides:
- A HamQTH-compatible XML API for callsign and advanced searches
- A lightweight web-based search UI
- A local, read-only FCC ULS callbook database
...
--------------------------
ARCS is an independently developed project and is **not affiliated with,
...
XML responses are formatted for compatibility with applications that support
the HamQTH API format. ARCS does not replicate paid or proprietary datasets.

Architecture Overview
---------------------
ARCS consists of three primary Docker containers managed by Docker Compose:
